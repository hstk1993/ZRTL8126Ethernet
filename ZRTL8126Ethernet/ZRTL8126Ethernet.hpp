...
#include "ZRTL8126EthernetLinux10016.hpp"
...
enum { kFlowControlOff = 0, kFlowControlOn = 0x01 };
...
class ZRTL8126 : public super {

OSDeclareDefaultStructors(ZRTL8126)
...
private:
  ...
  void interruptHandler(OSObject *client, IOInterruptEventSource *src,
                        int count);
  UInt32 rxInterrupt(IONetworkInterface *interface, uint32_t maxCount,
                     IOMbufQueue *pollQueue, void *context,
                     UInt32 queueIndex = 0);
  void txInterrupt(UInt32 queueIndex = 0);
  ...
  static IOReturn refillAction(OSObject *owner, void *arg1, void *arg2,
                               void *arg3, void *arg4);
...
#define R8126_MAX_MSIX_VEC 32
  IOInterruptEventSource *interruptSource[R8126_MAX_MSIX_VEC];
